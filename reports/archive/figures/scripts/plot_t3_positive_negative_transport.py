...
if __name__ == "__main__":
    ...
    if not data:
    raise SystemExit("No BP_T3_Window_Sensitivity_Pair evidence records found.")
    ...
    plt.legend()
    save_figure(ensure_output("reports/archive/figures/paper_B/t3_positive_negative_transport.png"))
