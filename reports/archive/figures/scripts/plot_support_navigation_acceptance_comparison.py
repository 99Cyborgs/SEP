...
if __name__ == "__main__":
    ...
    if len(data) < 2:
    raise SystemExit("Need accepted and rejected BP_Support_Portal_Funnel evidence records.")
    ...
    save_figure(ensure_output("reports/archive/figures/cross_domain_navigation/support_navigation_acceptance_comparison.png"))
