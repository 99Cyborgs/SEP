...
if __name__ == "__main__":
    ...
    if len(data) < 2:
        raise SystemExit("Need accepted and rejected BP_Clickstream_Docs_Funnel ledgers.")
    ...
    save_figure(ensure_output("figures/cross_domain_navigation/clickstream_acceptance_comparison.png"))
