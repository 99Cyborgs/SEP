...
if __name__ == "__main__":
    ...
    if not data:
        raise SystemExit("No cross-domain navigation ledgers found.")
    ...
    save_figure(ensure_output("figures/cross_domain_navigation/cross_domain_navigation_comparison.png"))
